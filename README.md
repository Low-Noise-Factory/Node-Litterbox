...
This is a [Litterbox](https://github.com/Gerharddc/litterbox) image that provides both the Node.js (with pnpm) toolchain. This image is suitable both for building inside a CI environment and as a local development environment.
...
```
FROM ghcr.io/low-noise-factory/node-litterbox:main
...
jobs:
  build-and-test:
    ...
    container:
      image: ghcr.io/low-noise-factory/node-litterbox:main
      options: --user root
